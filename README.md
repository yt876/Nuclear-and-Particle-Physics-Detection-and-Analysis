...
### 3. 射线与物质的相互作用（9 学分）<span class="tag-lab">实验</span>
...
### 4. 气体探测器（4 学分）<span class="tag-lab">实验</span>

1. 带电粒子与气体作用
2. 典型气体探测器
   - 电离室
   - 正比计数器
3. 拓展：信号（电荷、电压、电流）成型过程

**思考题**

### 5. 闪烁体探测器（4 学分）<span class="tag-lab">实验</span>
...
### 6. 半导体探测器（3 学分）<span class="tag-lab">实验</span>
